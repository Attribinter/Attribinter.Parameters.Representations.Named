...
public static class ParaminterNamedParameterRepresentationsServices
{
    ...
    public static IServiceCollection AddParaminterNamedParameterRepresentations(this IServiceCollection services)
    {
        if (services is null)
        {
